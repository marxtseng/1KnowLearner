...
public class EmbedFragment extends UnitFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_unit_embed, container, false);
    ...
    protected void initFragment() {
        try {
            ...
            webView.loadData(mUnit.getString("content"), "text/html; charset=utf-8", "utf-8");
